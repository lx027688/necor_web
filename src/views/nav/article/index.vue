...
<d2-container>
  ...
  <el-table :data="data" @sort-change="sortChange" @selection-change="selectionChangeHandle" v-loading="loading" stripe border style="width: 100%;margin-top: 10px;margin-bottom: 20px;">
    ...
    <el-table-column prop="introduction" header-align="center" align="center" label="简介"></el-table-column>
    <el-table-column prop="cont" header-align="center" align="center" label="内容"></el-table-column>
    <el-table-column prop="cover" header-align="center" align="center" label="封面"></el-table-column>
    <el-table-column prop="published" header-align="center" align="center" label="是否发布(码类100)"></el-table-column>
    <el-table-column prop="sourse" header-align="center" align="center" label="来源"></el-table-column>
    <el-table-column prop="sourseUrl" header-align="center" align="center" label="来源url"></el-table-column>
    <el-table-column prop="publishedDate" header-align="center" align="center" label="发布日期"></el-table-column>
    <el-table-column prop="hits" header-align="center" align="center" label="点击量"></el-table-column>
