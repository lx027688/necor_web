...
import { save, detail } from '@api/erp/depot'
...
export default {
	data () {
        ...
        address: ''
			...
			saveRule: {
				...
				tel: [ { pattern: /^1[3,4,5,7,8]\d{9}$/, message: '手机号格式不正确', trigger: 'blur' }, ],
	...
	methods: {
        ...
        this.getAreas('p')
            ...
            this.form.linkMan = r.data.linkMan
            this.form.tel = r.data.tel
