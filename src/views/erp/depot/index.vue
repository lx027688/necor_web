...
<d2-container>
    ...
    <el-table-column prop="province" header-align="center" align="center" label="省/市/区">
      <template slot-scope="scope">{{scope.row.province.name}}/{{scope.row.city.name}}/{{scope.row.district.name}}</template>
    </el-table-column>
...
<script>
import { list, remove } from '@api/erp/depot'
import pagination from '@/components/pagination'
import save from './save'

export default {
	name: 'system-erp-depot',
